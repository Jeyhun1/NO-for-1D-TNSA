"""
This file is the application of Fourier Neural Operator with a Fourier Feature
mapping in the lifting dimension
...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2, width):
        ...
        self.fc0 = nn.Linear(801, self.width)
    ...
    def forward(self, x):
        ...
        B_gauss = torch.randn((400, 2)).to(device) * 0.1
        grid = self.input_mapping(grid, B_gauss)
    ...
    def input_mapping(self, x, B):
        if B is None:
            ...
            a = torch.cat([torch.sin(x_proj), torch.cos(x_proj)], dim=-1)
            return a
...
dataset = loadmat('DIR/scratch/jeru889b-Smilei-ws/ion_N_100_0.5_10_400_400.mat')
...
path_model = 'DIR/scratch/jeru889b-Smilei-ws/fno/fnomodel/'+path
path_train_err = 'DIR/scratch/jeru889b-Smilei-ws/fno/fnoresults/'+path+'train.txt'
path_test_err = 'DIR/scratch/jeru889b-Smilei-ws/fno/fnoresults/'+path+'test.txt'
path_image = 'DIR/scratch/jeru889b-Smilei-ws/fno/fnoimage/'+path
...
scipy.io.savemat('DIR/scratch/jeru889b-Smilei-ws/fno/pred_data/'+path+'.mat', data)