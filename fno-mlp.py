"""
This file is the application of Fourier Neural Operator with a MLP
lifting dimension
...
path = 'ns_fourier_ion_400_400_'+str(ntrain)+'_ep' + str(epochs) + '_m' + str(modes1) + '_w' + str(width) + '_' + str(wandb.run.id)
