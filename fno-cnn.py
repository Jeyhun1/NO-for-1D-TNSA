"""
This file is the application of Fourier Neural Operator with a CNN
lifting dimension
...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2, width):
        ...
        self.cnn_conv0 = nn.Conv2d(3, self.width, 3, padding=1) 
        self.cnn_conv1 = nn.Conv2d(self.width, self.width, 3, padding=1) 
        self.cnn_conv2 = nn.Conv2d(self.width, self.width, 3, padding=1) 
        self.cnn_conv3 = nn.Conv2d(self.width, self.width, 3, padding=1) 
