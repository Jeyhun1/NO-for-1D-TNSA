"""
This file is the application of Fourier Convolutional Neural Operator 
...
class CNN(nn.Module):
    def __init__(self, input_channels, output_channels, kernel_size):
        ...
        self.cnn_conv0 = nn.Conv2d(input_channels, output_channels, kernel_size, padding=1) 
        self.cnn_conv1 = nn.Conv2d(input_channels, output_channels, kernel_size, padding=1) 
        self.cnn_conv2 = nn.Conv2d(input_channels, output_channels, kernel_size, padding=1) 
        # self.cnn_conv3 = nn.Conv2d(input_channels, output_channels, kernel_size, padding=1) 
...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2, width):
        ...
        self.cnn = CNN(self.width, self.width,3)
